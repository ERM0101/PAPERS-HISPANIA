...
namespace HispaniaCommon.ViewClientWPF.Windows
{
    ...
    /// </summary>
    public partial class HistoGoods : Window
    {
        #region Constants
        ...
        /// Store the data to show in List of Items.
        /// </summary>
        private ObservableCollection<HistoGoodsView> m_DataList = new ObservableCollection<HistoGoodsView>();
        ...
        /// </summary>
        public ObservableCollection<HistoGoodsView> DataList
        {
            get
            {
                return (m_DataList);
            ...
            set
            {
                ...
                else m_DataList = new ObservableCollection<HistoGoodsView>();
                ListItems.ItemsSource = m_DataList;
                ListItems.DataContext = this;
                CollectionViewSource.GetDefaultView(ListItems.ItemsSource).SortDescriptions.Add(new SortDescription("Year", ListSortDirection.Descending));
        ...
        public HistoGoods(ApplicationType AppType)
        {
            InitializeComponent();
            Initialize(AppType);
        }
        ...
        private void LoadDataInWindowComponents()
        {
            //  Set Data into the Window.
                ...
                CollectionViewSource.GetDefaultView(ListItems.ItemsSource).Filter = UserFilter;
                cbFieldItemToSearch.ItemsSource = HistoGoodsView.Fields;
                cbFieldItemToSearch.DisplayMemberPath = "Key";
                cbFieldItemToSearch.SelectedValuePath = "Value";
                if (HistoGoodsView.Fields.Count > 0) cbFieldItemToSearch.SelectedIndex = 0;
        }
        ...
        private bool UserFilter(object item)
        {
            //  Get Acces to the object and the property name To Filter.
                HistoGoodsView ItemData = (HistoGoodsView)item;
            ...
            //  Apply the filter
                ...
                else
                {
                    ...
                    {
                        return GlobalViewModel.GetDateForUI((DateTime)valueToTest).Contains(tbHistoGoodToSearch.Text);
                    }
                    else return ((valueToTest.ToString().ToUpper()).Contains(tbHistoGoodToSearch.Text.ToUpper()));
                }
        }
        ...
        private void LoadManagers()
        {
            ...
            //  TextBox
                tbHistoGoodToSearch.TextChanged += TbHistoGoodToSearch_TextChanged;
        }
        ...
        private void TbHistoGoodToSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
        ...
        private void BtnRefresh_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ActualizeHistoGoodsFromDb();
            }
            catch (Exception ex)
            {
                MsgManager.ShowMessage(string.Format("Error, al refrescar els valors dels Històric d'Artícles.", MsgManager.ExcepMsg(ex)));
            }
        }
        ...
        private void ActualizeHistoGoodsFromDb()
        {
            //  Actualize Item Information From DataBase
                DataList = GlobalViewModel.Instance.HispaniaViewModel.GetHistoGoods(Data.Good_Id);
        }
