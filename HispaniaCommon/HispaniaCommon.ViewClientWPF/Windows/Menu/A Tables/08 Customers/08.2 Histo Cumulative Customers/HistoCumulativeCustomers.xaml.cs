...
{
    /// <summary>
    /// Interaction logic for HistoCumulativeCustomers.xaml
    /// </summary>
    public partial class HistoCumulativeCustomers : Window
    {
        #region Constants
        ...
        /// Store the data to show in List of Items.
        /// </summary>
        private ObservableCollection<HistoCumulativeCustomersView> m_DataList = new ObservableCollection<HistoCumulativeCustomersView>();
        ...
        /// </summary>
        public ObservableCollection<HistoCumulativeCustomersView> DataList
        {
            get
            {
                return (m_DataList);
            ...
            set
            {
                ...
                else m_DataList = new ObservableCollection<HistoCumulativeCustomersView>();
        ...
        public HistoCumulativeCustomers(ApplicationType AppType)
        {
            InitializeComponent();
            Initialize(AppType);
        }
        ...
        private void LoadDataInWindowComponents()
        {
            //  Set Data into the Window.
                ...
                CollectionViewSource.GetDefaultView(ListItems.ItemsSource).Filter = UserFilter;
                cbFieldItemToSearch.ItemsSource = HistoCumulativeCustomersView.Fields;
                cbFieldItemToSearch.DisplayMemberPath = "Key";
                cbFieldItemToSearch.SelectedValuePath = "Value";
                if (HistoCumulativeCustomersView.Fields.Count > 0) cbFieldItemToSearch.SelectedIndex = 0;
        }
        ...
        private bool UserFilter(object item)
        {
            //  Get Acces to the object and the property name To Filter.
                HistoCumulativeCustomersView ItemData = (HistoCumulativeCustomersView)item;
            ...
            //  Apply the filter
                ...
                else
                {
                    ...
                    {
                        return GlobalViewModel.GetDateForUI((DateTime)valueToTest).Contains(tbHistoCumulativeCustomerToSearch.Text);
                    }
                    else return ((valueToTest.ToString().ToUpper()).Contains(tbHistoCumulativeCustomerToSearch.Text.ToUpper()));
                }
        }
        ...
        private void LoadManagers()
        {
            ...
            //  TextBox
                tbHistoCumulativeCustomerToSearch.TextChanged += TbHistoCumulativeCustomerToSearch_TextChanged;
        }
        ...
        private void TbHistoCumulativeCustomerToSearch_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
        ...
        private void BtnRefresh_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ActualizeHistoCumulativeCustomersFromDb();
            }
            catch (Exception ex)
            {
        ...
        private void ActualizeHistoCumulativeCustomersFromDb()
        {
            //  Actualize Item Information From DataBase
                DataList = GlobalViewModel.Instance.HispaniaViewModel.GetHistoCumulativeCustomers(Data.Customer_Id);
        }
