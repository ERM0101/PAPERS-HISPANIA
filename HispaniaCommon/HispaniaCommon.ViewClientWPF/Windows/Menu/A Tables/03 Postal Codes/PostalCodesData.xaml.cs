...
namespace HispaniaCommon.ViewClientWPF.UserControls
{
    ...
    /// </summary>
    public partial class PostalCodesData : UserControl
    {
        #region Constants
        ...
        /// </summary>
        /// <param name="NewOrEditedPostalCodes">New or Edited City and Postal Code.</param>
        public delegate void dlgAccept(PostalCodesView NewOrEditedPostalCodes);
        ...
        /// <summary>
        /// Store the City and Postal Code data to manage.
        /// </summary>
        private PostalCodesView m_PostalCode = null;
        ...
        public PostalCodesView PostalCode
        {
            ...
            set
            {
                if (value != null)
                {
                    ...
                    m_PostalCode = value;
                    EditedPostalCodes = new PostalCodesView(m_PostalCode);
                    LoadDataInControls(m_PostalCode);
                }
                else throw new ArgumentNullException("Error, no s'han trobat les dades del Codi Postal o la Ciutat a carregar."); 
            }
        }
        ...
        public Operation CtrlOperation
        {
            ...
            set
            {
                ...
                {
                    case Operation.Show :
                         if (PostalCode == null) throw new InvalidOperationException("Error, impossible visualitzar el Codi Postal o la Ciutat sense dades.");
                         tbCancel.Text = "Tornar";
                         break;
                    case Operation.Add:
                         PostalCode = new PostalCodesView();
                         tbCancel.Text = "Cancel·lar";
                         break;
                    case Operation.Edit:
                         if (PostalCode == null) throw new InvalidOperationException("Error, impossible editar un Codi Postal o Ciutat sense dades.");
                         tbCancel.Text = "Cancel·lar";
                         break;
                }
        ...
        /// <summary>
        /// Get or Set the Edited City and Postal Code information.
        /// </summary>
        private PostalCodesView EditedPostalCodes
        {
            get;
            set;
        }
        ...
        private void InitEditableControls()
        {
            ...
            {
                lblPostalCodes_PostalCode,
                tbPostalCodes_PostalCode,
                lblPostalCodes_City,
                tbPostalCodes_City,
                lblPostalCodes_Province,
                tbPostalCodes_Province
            };
        }
        ...
        /// </summary>
        private void LoadDataInControls(PostalCodesView postalCodesView)
        {
            DataChangedManagerActive = false;
            tbPostalCodes_PostalCode.Text = postalCodesView.Postal_Code;
            tbPostalCodes_City.Text = postalCodesView.City;
            tbPostalCodes_Province.Text = postalCodesView.Province;
        ...
        private void LoadManagers()
        {
            //  By default the manager for the Customer Data changes is active.
                DataChangedManagerActive = true;
            //  TextBox
                tbPostalCodes_PostalCode.PreviewTextInput += TBPreviewTextInput;
                tbPostalCodes_PostalCode.TextChanged += TBDataChanged;
                tbPostalCodes_City.PreviewTextInput += TBPreviewTextInput;
                tbPostalCodes_City.TextChanged += TBDataChanged;
                tbPostalCodes_Province.PreviewTextInput += TBPreviewTextInput;
                tbPostalCodes_Province.TextChanged += TBDataChanged;
            //  Buttons
        ...
        {
            if (sender == tbPostalCodes_PostalCode) e.Handled = ! GlobalViewModel.IsValidPostalCodeChar(e.Text);
            else if (sender == tbPostalCodes_City) e.Handled = ! GlobalViewModel.IsValidNameChar(e.Text);
            else if (sender == tbPostalCodes_Province) e.Handled = ! GlobalViewModel.IsValidNameChar(e.Text);
        }
        ...
        private void TBDataChanged(object sender, TextChangedEventArgs e)
        {
            if (DataChangedManagerActive)
            {
                ...
                try
                {
                    if (sender == tbPostalCodes_PostalCode) EditedPostalCodes.Postal_Code = value;
                    else if (sender == tbPostalCodes_City) EditedPostalCodes.City = value;
                    else if (sender == tbPostalCodes_Province) EditedPostalCodes.Province = value;
                }
                catch (Exception ex)
                {
                    MsgManager.ShowMessage(MsgManager.ExcepMsg(ex));
                    LoadDataInControls(EditedPostalCodes);
                }
                AreDataChanged = (EditedPostalCodes != PostalCode);
                DataChangedManagerActive = true;
        ...
        {
            PostalCodeAttributes ErrorField = PostalCodeAttributes.None;
            try
            {
                if ((CtrlOperation == Operation.Add) || (CtrlOperation == Operation.Edit))
                {
                    EditedPostalCodes.Validate(out ErrorField);
                    EvAccept?.Invoke(new PostalCodesView(EditedPostalCodes));
                }
            }
            catch (Exception ex)
            {
        ...
        {
            EditedPostalCodes.RestoreSourceValues(PostalCode);
            LoadDataInControls(EditedPostalCodes);
            AreDataChanged = (EditedPostalCodes != PostalCode);
        }
        ...
        /// </summary>
        /// <param name="ErrorField"></param>
        public void RestoreSourceValue(PostalCodeAttributes ErrorField)
        {
            EditedPostalCodes.RestoreSourceValue(PostalCode, ErrorField);
            LoadDataInControls(EditedPostalCodes);
            AreDataChanged = (EditedPostalCodes != PostalCode);
        }
